...
import { ArrowRight, ClipboardList, Sparkles, Trophy, User } from "lucide-react";
  ...
  head: () => ({
    meta: [
      { title: "RallyPoint — платформа для клубов настольного тенниса" },
      {
        name: "description",
        content:
          "Кликабельный прототип RallyPoint: лента клуба, рейтинги, турниры, судейство столов и онбординг клуба в стиле Material Design 3.",
      },
      { property: "og:title", content: "RallyPoint — платформа для клубов настольного тенниса" },
      {
        property: "og:description",
        content: "Прототип SaaS для клубов настольного тенниса: игрок, администратор и судья.",
      },
    ],
  }),
  component: Launcher,
...
function Launcher() {
  return (
    <div className="min-h-dvh bg-surface">
      <main className="mx-auto flex max-w-md flex-col gap-8 px-5 pt-14 pb-12">
        <div>
          ...
          <p className="mt-3 text-base leading-relaxed text-on-surface-variant">
            Прототип платформы для клубов настольного тенниса. Клуб «ТопСпин» уже
            настроен — выберите роль, чтобы пройти её сценарий.
          </p>
        </div>
