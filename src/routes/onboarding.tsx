...
const ENGINES = [
  ...
  },
  {
    id: "glicko",
    name: "Glicko-2",
    desc: "Как Эло, но быстрее находит уровень новых и давно неактивных игроков.",
    tag: "Рекомендуется",
  },
  {
    id: "points",
    name: "Elo + RTTF",
    desc: "Победа = +N очков, поражение = 0. Легко объяснить, но менее точно учитывает силу соперника.",
    tag: null,
  },
];
